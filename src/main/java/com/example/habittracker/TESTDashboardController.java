...
public class TESTDashboardController {
    ...
    @FXML
    private Pane HabitPane; // Pane für die neuen Habits
    ...
    private void addHabitToPane(String habitName) {
        Text habitText = new Text(habitName); // Textknoten für den Habit
        habitText.setFont(new Font(14)); // Schriftgröße setzen
        HabitPane.getChildren().add(habitText); // Füge den Text dem HabitPane hinzu
    }
